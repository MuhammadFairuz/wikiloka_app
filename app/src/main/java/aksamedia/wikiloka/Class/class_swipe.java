...
/**
 * Dibuat oleh Sony Vaio pada 20/02/2016.
 */
import android.view.MotionEvent;
import android.view.View;

public class class_swipe implements View.OnTouchListener {
    ...
    private static class_swipe newInstance(){
        return new class_swipe();
    }

    public static void detect( View view, SwipeCallback swipeCallback  ){
        class_swipe evt = class_swipe.newInstance();
